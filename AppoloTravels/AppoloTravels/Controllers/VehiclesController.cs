...
namespace AppoloTravels.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DriverID,DriverName,DriverContactNumber,Location,VehicleNumber,Capacity,SeatsAvailable")] Vehicle vehicle)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("DriverID,DriverName,DriverContactNumber,Location,VehicleNumber,Capacity,SeatsAvailable")] Vehicle vehicle)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!VehicleExists(vehicle.DriverID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Vehicles.Any(e => e.DriverID == id);
        }
    }
}
